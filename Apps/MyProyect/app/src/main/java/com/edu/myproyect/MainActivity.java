...
import com.edu.myproyect.databinding.ActivityMainBinding;
        ...
        switch (view.getId()){
            case R.id.BtnlogIn:
                ...
                if(cursor.getCount() > 1){
                    Intent productos = new Intent(this, com.edu.cesde.Refgistrar.RegisterActivity.class);
                ...
                break;
            case R.id.BtnSingUP:
                Intent intent = new Intent(this, com.edu.cesde.Refgistrar.RegisterActivity.class);
